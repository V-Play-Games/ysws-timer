      ...
      <div className="mb-8">
        ...
        <div className="space-y-2 text-gray-600 dark:text-gray-300">
          <p><strong>Email: </strong>
            <a href="mailto:vaibhavnargwani28@gmail.com" className="text-blue-600 dark:text-blue-400 hover:opacity-80 transition-all">
              vaibhavnargwani28@gmail.com
            </a>
          </p>
          <p><strong>GitHub: </strong>
            <a href="https://github.com/V-Play-Games" className="text-blue-600 dark:text-blue-400 hover:opacity-80 transition-all">
